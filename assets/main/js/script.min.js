...
function customDropdown() {
  ...
  e.forEach((t) => {
    ...
    let i = t.querySelector(".value-select");
    o.addEventListener("click", function (e) {
      ...
      e.forEach((n) => {
        n.addEventListener("click", function (e) {
          e.stopPropagation();
          var e = i.querySelector("img").src,
            t = i.querySelector("span").textContent,
            o = (i.innerHTML, n.innerHTML);
          (i.innerHTML = o),
  ...
  $("section.accommodation").length < 1 ||
    $("section.accommodation").each(function () {
      var e = $(this),
        ...
        i = t.hasClass("offer-slider");
      new Swiper(t[0], {
        spaceBetween: 40,
        slidesPerView: i ? 2.5 : 3.3,
        speed: 1e3,
...
function swiperAccommodation() {
  var e = $(".swiper-accomodation");
  e.length < 1 ||
    e.each(function () {
      var e = $(this),
        t = e.closest("section.accommodation-detail"),
        o = t.find(".swiper-pagination"),
        n = t.find(".swiper-button-prev"),
        t = t.find(".swiper-button-next");
      new Swiper(e[0], {
        slidesPerView: 2.5,
        spaceBetween: 16,
        slidesOffsetAfter: 80,
        ...
        parallax: !0,
        pagination: { el: o[0], type: "progressbar" },
        navigation: { prevEl: n[0], nextEl: t[0] }
      });
    });
}
function ctaMess() {
...
function loadingBanner() {
      ...
      scrollTrigger: {
        ...
        onUpdate: (e) => {
          1 !== e.progress ||
            ...
            document.querySelectorAll(".anim-clip-circle").forEach((e) => {
              e.classList.remove("anim-clip-circle");
            }),
        ...
        onLeave: () => {
          ScrollTrigger.getById(o.scrollTrigger.id)?.disable();
          var e = document.querySelector(".banner-hero-clip");
          e &&
            ((e.style.position = ""),
            (e.style.top = ""),
            (e.style.height = "")),
  ...
  o.to(".anim-clip-circle", { clipPath: "circle(70.7% at 50% 50%)" }).to(
